...
El cálculo es exactamente el mismo que el del KPI1, con la diferencia de que unicamente se toman en cuenta las victimas que, en la base de datos, aparecen como Peatones y Mujeres
